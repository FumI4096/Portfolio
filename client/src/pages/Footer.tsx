...
export default function Footer(){
    return(
        <footer className="max-w-[1700px] mx-auto h-1000 flex flex-col bg-background p-14rem justify-center max-xl:py-6rem max-xl:px-8rem max-md:px-[4.5rem] max-840:gap-6 max-md:h-auto max-xs:px-[2.5rem]">
