...
export default function Stack(){
    return (
        <section id="services" className='bg-primary-gray-1 h-1000 py-10rem px-14rem flex items-center justify-between flex-col max-2xl:h-auto max-xl:py-6rem max-xl:px-8rem max-md:px-[4.5rem]'>
            <h2 className="font-poppins-semibold text-5xl text-white max-2xl:mb-[5rem] max-lg:text-4xl">Services &#38; Tools</h2>
