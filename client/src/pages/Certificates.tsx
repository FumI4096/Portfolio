...
export default function Certificate(){
    return (
        <section id="credentials" className='max-w-[1700px] mx-auto h-auto flex flex-col bg-primary-gray-1 px-14rem py-10rem items-center justify-between max-2xl:h-auto max-xl:py-6rem max-xl:px-8rem max-sm:px-[4.5rem] max-xs:px-[1rem]'>
