...
export default function Certificate(){
    return (
        <section id="credentials" className='h-1000 flex flex-col bg-primary-gray-1 px-14rem py-10rem items-center justify-between max-2xl:h-auto max-xl:py-6rem max-xl:px-8rem max-sm:px-[4.5rem]'>
            <h2 className="font-poppins-semibold text-5xl text-white max-2xl:mb-[5rem] max-md:text-4xl">My Credentials</h2>
