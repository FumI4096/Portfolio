...
export default function Experience() {
    ...
    return (
        <section
            id="experience"
            className="max-w-[1700px] mx-auto bg-primary-gray-1 h-auto py-10rem px-14rem flex flex-col items-center justify-center gap-7 max-2xl:h-auto max-xl:py-6rem max-xl:px-8rem max-md:px-[4.5rem] max-xs:px-[1rem]"
        >
