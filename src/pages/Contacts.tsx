        ...
        <section className='bg-primary-gray-1 h-1000 py-10rem px-14rem flex items-center justify-center flex-row gap-7'>
            ...
            <article className="h-full w-full flex flex-col">
                ...
                <form action="" className="flex flex-col gap-8 justify-end w-full font-poppins-light">
                    ...
                    <input type="text" placeholder="Subject" className="w-full h-12 p-2 outline-none shadow-2xl bg-white border-b-[5px] border-primary-gray-3 bg-opacity-20 placeholder:text-white text-white focus:bg-primary-gray-2 hover:cursor-type focus:cursor-text focus:placeholder:text-primary-gray-3 duration-150 rounded-sm"/>
